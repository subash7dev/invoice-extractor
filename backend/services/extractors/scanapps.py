...
from services.scanapps_parser import ScanAppsParser
from services.llm import LLMService


class ScanAppsExtractor(BaseExtractor):
    """
    ScanApps Invoice Extractor

    Strategy:
    1. ScanApps rule-based parser
    ...
    def extract(
        ...
        scanapps_data = ScanAppsParser.extract(text)
        ...
        parser_data.update(

            {
                ...
                for key, value in scanapps_data.items()
